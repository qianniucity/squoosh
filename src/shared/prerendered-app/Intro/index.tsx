        ...
        <div class={style.main}>
          ...
          <div class={style.loadImg}>
            ...
            >
              ...
              <div>
                <span class={style.dropText}>拖放 </span>OR{' '}
            ...
            <SlideOnScroll>
              <div class={style.infoContent}>
                <div class={style.infoTextWrapper}>
                  ...
                  <p class={style.infoCaption}>
                    打开您的图像，检查差异，然后立即保存。想要尝试更多？调整设置以获得更小的文件。
                  </p>
                </div>
                <div class={style.infoImgWrapper}>
                  <img
            ...
            <div class={style.footerPadding}>
              <footer class={style.footerItems}>
                <a
                  ...
                  href="https://github.com/qianniucity/squoosh/blob/dev/README.md#privacy"
                >
                  Privacy
                </a>
                <a
                  class={style.footerLinkWithLogo}
                  href="https://github.com/qianniucity/squoosh"
                >
